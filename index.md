...
@media screen and (max-width: 500px) {
  ...
  <a href="vasnastos.github.io/Algorithms_and_complexity/2nd.md"><i class="active"></i>Techical Report</a>
</div>
  <br><br>
...
of variation) που ορίζεται ως η τυπική απόκλιση προς τη μέση τιμή.</li>
    ...
    <li>Πρόσφτατα ενημερωμένη Τεχνική Αναφορά</li>
    <ul>
      <li>Techical Report:<a href="">Word</a></li>
      </ul>
    </ol>
